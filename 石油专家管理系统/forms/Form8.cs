        ...
        private void button1_Click(object sender, EventArgs e)
        {
         ...
         //   string s19 = "select 工况 from [dbo].[Sheet4$] where 工程编号='" + textBox1.Text + "'";
          ...
          //  DataSet read19 = SQLHelper.read(s19);
            string x = read.Tables[0].Rows[0]["井型"].ToString() ;
            ...
            double x6 = Convert.ToDouble(read6.Tables[0].Rows[0]["外径"]);
            double x7 =Convert.ToDouble( read7.Tables[0].Rows[0]["总长"]);
            ...
            double x16 = Convert.ToDouble(read16.Tables[0].Rows[0]["壁厚"]);
            string x17 = read17.Tables[0].Rows[0]["公司名称"].ToString();
            string x18 = read18.Tables[0].Rows[0]["井队"].ToString();
           // string x19 = read19.Tables[0].Rows[0]["工况"].ToString();
